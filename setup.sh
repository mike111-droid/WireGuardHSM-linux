...
sed -i  "s|#define WORK_DIR .*|#define WORK_DIR         \"$WORK_DIR\"|" wireguard/settings.h
...
sed -i "s|#define SCSH3_DIR .*|#define SCSH3_DIR         \"$SCSH3_DIR\"|" wireguard/settings.h
...
sed -i "s|#define INTERFACE .*|#define INTERFACE        \"$INTERFACE\"|" wireguard/settings.h
...
sed -i "s|#define MAX_PEERS .*|#define MAX_PEERS        $MAX_PEERS|" wireguard/settings.h
...
sed -i "s|#define ENABLE_HSM .*|#define ENABLE_HSM       \"$ENABLE_HSM\"|" wireguard/settings.h
...
sed -i "s|#define ENABLE_TIMESTAMP .*|#define ENABLE_TIMESTAMP \"$ENABLE_HSM\"|" wireguard/settings.h

gcc -o start wireguard/wireguardhsm.c
