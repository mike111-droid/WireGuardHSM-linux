...
## ToDo's
- [ ] **PIN Managment:** At the moment the PIN is written in *scsh3/wireguard_damon.js*. *wireguardhsm/wireguardhsm.c* should manage the PIN, also with possible user input.
