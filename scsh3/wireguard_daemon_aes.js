/*
 * wireguard_daemon_aes.js
 * Hashes oldpsk and signs it with the key AES_KEY on the HSM. Then prints result in base64 to consol in format "++++<RESULT>"
 */
...
print(key);
print(key.getType());
print("Crypto.AES_CMAC");
var signature = sc.getCrypto().sign(key, Crypto.AES_CMAC, message);
